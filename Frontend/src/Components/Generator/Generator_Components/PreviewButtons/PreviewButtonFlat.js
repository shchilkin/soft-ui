...
export default PreviewButtonFlat;


const handleBackgroundType = (state,backgroundMain,color,accent) => {
    switch (state) {
        case "active":
...
const handleShadowType = (state, shadowLength,Blur,darkerShadow,lighterShadow,color) => {
    switch (state) {
        case "active":
...
const StyledButton = styled.button`
    ...
    ${({ state,...props }) => handleShadowType(state, props.shadowLength, props.Blur, props.darkerShadow, props.lighterShadow, props.color )};
    `;