...
//TODO: add props or implement dymanic color change
/**
 * Soft UI Vector logo
 */
const Logo = () : JSX.Element =>  {
  ...
  return (
      <div id='logo'>
            <svg width="100%" height="100%" viewBox="0 0 222 222" style={{fillRule:'evenodd',clipRule:'evenodd',strokeLinejoin:'round',strokeMiterlimit:2}}>
                  ...
                  //TODO: Get fill color from store
                        style={{fill:`#ed2939`}}/>
